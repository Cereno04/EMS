            ...
            <div class="w-full max-w-[380px]">
                ...
                <div id="login-form" class="transition-all duration-300">
                    ...
                    <form action="/login" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <!-- FIX: Added oninput to allow ONLY numbers -->
                        ...
                        <button type="submit" class="w-full bg-[#2563eb] hover:bg-blue-700 text-white font-bold py-3.5 rounded-xl transition-all shadow-md text-sm">
                            Sign in
                        </button>
                ...
                <div id="signup-form" class="hidden transition-all duration-300">
                    ...
                    <form action="/signup" method="POST" class="space-y-4">
                        ...
                        <!-- Only Numbers for Signup ID too -->
                        ...
                        <button type="submit" class="w-full bg-[#2563eb] hover:bg-blue-700 text-white font-bold py-3 rounded-xl shadow-md mt-2 text-sm">
                            Register
                        </button>
                    </form>
